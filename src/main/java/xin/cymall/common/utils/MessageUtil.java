...
public class MessageUtil {
    ...
    public static String picmessageToXml(PicMessage textMessage) {
        xstream.alias("xml", textMessage.getClass());
        return xstream.toXML(textMessage);
    }
    public static String getXml(String touser ,String fromusername ) {
        StringBuffer str = new StringBuffer();
              str.append("<xml>"+"\n");
                  ...
                  str.append("<Content><![CDATA[" + "测试文本消息" + "]]></Content>"+"\n");
                  str.append("</xml>");
                  return str.toString();
    }
