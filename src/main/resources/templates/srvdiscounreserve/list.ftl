...
<div class="layui-btn-group">
        <@shiro.hasPermission name="srvdiscounreserve:save">
        <button class="layui-btn" onclick="addPage('/srvdiscounreserve/add')">
        ...
        <button class="layui-btn" onclick="editPage('srvDiscounreserveTable','/srvdiscounreserve/edit')">
         ...
         <button class="layui-btn layui-btn-green" onclick="updateState('批量启用','srvDiscounreserveTable','/srvdiscounreserve/enable')">
            <i class="fa fa-check-square-o">&nbsp;</i>启用
        </button>
        <button class="layui-btn  layui-btn-danger" onclick="updateState('批量禁用','srvDiscounreserveTable','/srvdiscounreserve/limit')">
