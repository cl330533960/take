...
<head>
    ...
    <script type="text/javascript" src="/srvusercomment/js/list.js"></script>
</head>
<body>
<form class="layui-form " action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-normal">
            ...
            <button class="layui-btn search-btn" table-id="srvUserCommentTable" lay-submit="" lay-filter="search">
...
<div class="layui-btn-group">
        <@shiro.hasPermission name="srvusercomment:save">
        <button class="layui-btn" onclick="addPage('/srvusercomment/add')">
            <i class="fa fa-plus">&nbsp;</i>增加
        </button>
        </@shiro.hasPermission>
        <@shiro.hasPermission name="srvusercomment:update">
        ...
        <@shiro.hasPermission name="srvusercomment:delete">
         <button class="layui-btn layui-btn-delete" onclick="deleteBatch('批量删除','srvUserCommentTable','/srvusercomment/delete');">
...
<div class="layui-form ">
    <table class="layui-table" id="srvUserCommentTable" cyType="pageGrid"
           cyProps="url:'/srvusercomment/listData',checkbox:'true',pageColor:'#2991d9'">
        <thead>
        <tr>
            <!--复选框-->
