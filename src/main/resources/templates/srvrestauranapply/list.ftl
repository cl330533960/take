...
<div class="layui-btn-group">
        ...
        <#--</button>-->
         <button class="layui-btn layui-btn-green" onclick="updateState('批量通过','srvRestauranapplyTable','/srvrestauranapply/enable')">
            <i class="fa fa-check-square-o">&nbsp;</i>通过
        </button>
        <button class="layui-btn  layui-btn-danger" onclick="updateState('批量拒绝','srvRestauranapplyTable','/srvrestauranapply/limit')">
            <i class="fa fa-expeditedssl">&nbsp;</i>拒绝
        </button>
        </@shiro.hasPermission>
        <@shiro.hasPermission name="srvrestauranapply:delete">
         <button class="layui-btn layui-btn-delete" onclick="deleteBatch('批量删除','srvRestauranapplyTable','/srvrestauranapply/delete');">
